Config.Locations =  {
    ["Centres"] = {
        ["RecycleCity"] = {
            ...
            Blip = {
                blipEnable = true,
                name = "Återvinningscenter",
                coords = vector4(746.62, -1399.32, 26.63, 0.63),
                blipTrue = true,
                sprite = 365,
                col = 2,
        ...
        ["RecycleNorth"] = {
            ...
            Blip = {
                blipEnable = true,
                name = "Återvinningscenter",
                coords = vector4(55.55, 6472.18, 36.42, 313.51),
                blipTrue = true,
                sprite = 365,
                col = 2,
    ...
    ['Recycle'] = {
        { coords = vector4(738.14, -1399.58, 27.88, 184.52),
            Ped = { model = "s_m_y_garbage", scenario = "WORLD_HUMAN_CLIPBOARD", },
            Blip = { blipEnable = false, name = "Recycle Buyer", sprite = 642, col = 2, },
        }
    },
    ['BottleBanks'] = {
        {  coords = vector4(770.89, -1399.57, 26.54, 198.36),
            Ped = { model = "a_m_o_salton_01", scenario = "WORLD_HUMAN_DRUG_DEALER", },
            Blip = { blipEnable = true, name = "Pantamera", sprite = 642, col = 2, },
        },
        {  coords = vector4(59.32, 6478.13, 31.43, 324.81),
            Ped = { model = "a_m_o_soucent_03", scenario = "WORLD_HUMAN_DRUG_DEALER", },
            Blip = { blipEnable = true, name = "Pantamera", sprite = 642, col = 2, },
        },
    },
}